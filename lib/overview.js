...
async function computeOverview(range, env, cust, view) {
  ...
  const [signups, payments, revenue, growth, dailyPay, pgSubscribers, todayPay, sameWin, payersBySrc, visitorsBySrc, pgSignupTotals, pgRevenueTotals] = await Promise.all([
    runHogQL(`
